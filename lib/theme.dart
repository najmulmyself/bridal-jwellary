...
static const lightSecondary = Color(0xFF8C6A1E); // Deep gold/brown for accents
...
textTheme: TextTheme(
displayLarge: GoogleFonts.playfairDisplay(fontSize: FontSizes.displayLarge, fontWeight: FontWeight.w600, height: 1.1),
displayMedium: GoogleFonts.playfairDisplay(fontSize: FontSizes.displayMedium, fontWeight: FontWeight.w600, height: 1.1),
displaySmall: GoogleFonts.playfairDisplay(fontSize: FontSizes.displaySmall, fontWeight: FontWeight.w600, height: 1.1),
headlineLarge: GoogleFonts.playfairDisplay(fontSize: FontSizes.headlineLarge, fontWeight: FontWeight.w600, height: 1.2),
headlineMedium: GoogleFonts.playfairDisplay(fontSize: FontSizes.headlineMedium, fontWeight: FontWeight.w600, height: 1.2),
headlineSmall: GoogleFonts.playfairDisplay(fontSize: FontSizes.headlineSmall, fontWeight: FontWeight.w600, height: 1.2),
titleLarge: GoogleFonts.playfairDisplay(fontSize: FontSizes.titleLarge, fontWeight: FontWeight.w600, height: 1.2),
titleMedium: GoogleFonts.playfairDisplay(fontSize: FontSizes.titleMedium, fontWeight: FontWeight.w600, height: 1.2),
titleSmall: GoogleFonts.playfairDisplay(fontSize: FontSizes.titleSmall, fontWeight: FontWeight.w600, height: 1.2),
...
shape: WidgetStatePropertyAll(RoundedRectangleBorder(borderRadius: BorderRadius.circular(AppTokens.r12))),
